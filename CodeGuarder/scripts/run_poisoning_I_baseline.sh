...
CG_PYTHON_SCRIPT="/home/bo/Security/CodeGuarder/src/Baseline_Poisoning_I.py"
OUTPUT_PATH="./dataset/Poisoning_I.json"
...
RESPONSE_PATH="./results/poisoning_I_ori_${MODEL_NAME}.json"
