...
CG_PYTHON_SCRIPT="./src/Defense_Standard.py"
OUTPUT_PATH="./dataset/Standard_Def.json"
...
RESPONSE_PATH="./results/std_def_${MODEL_NAME}.json"
BROKEN_INST_PATH="./dataset/Broken_instruct.json"
POISONED_PATH="./dataset/Standard.json"
