...
CG_PYTHON_SCRIPT="./src/Defense_Poisoning_II.py"
OUTPUT_PATH="./dataset/Poisoning_II_Def.json"
...
RESPONSE_PATH="./results/poisoning_II_def_${MODEL_NAME}.json"
BROKEN_INST_PATH="./dataset/Broken_instruct.json"
POISONED_PATH="./dataset/Poisoning_II.json"
