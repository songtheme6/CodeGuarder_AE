...
CG_PYTHON_SCRIPT="/home/bo/Security/CodeGuarder/src/Baseline_Poisoning_II.py"
OUTPUT_PATH="./dataset/Poisoning_II.json"
...
RESPONSE_PATH="./results/poisoning_II_ori_${MODEL_NAME}.json"
